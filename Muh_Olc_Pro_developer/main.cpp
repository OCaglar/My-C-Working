...
#define pi 3.141592654
	...
	if(Vhesap<18.5) printf("\n\nKritik sinirin altindasin, kisaca cok zayýfsin....\nACIL kilo almalisin!!!");
		...
		case 10:
		    ...
		    while (q<=e_sayisi){
				...
				if (q>=9){
					...
					printf("\nUZGUNUM...Yalnizca 8 ve altýndaki degerleri hesaplayabilirim!");
					break;}
			if (q==e_sayisi){
...
if(secim=='E'||secim=='e'){
	...
	case 3:
		...
		case 4:
			...
			sonuc1=n-f-1;
			sonuc2=n-f;
			printf("\n\n\nF tablodan bakilacak deger==>F==>1,%.0lf==>bakýlcak yuzde==>%.3lf",sonuc1,deger);
